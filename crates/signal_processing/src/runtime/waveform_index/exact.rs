use super::types::SAMPLES_PER_L1_BIT;
...
mod tests {
    ...
    use crate::runtime::capture::{BlockCaptureSource, BlockData, CaptureDataSource, CaptureFingerprint, CaptureMetadata, CaptureSource, CaptureWaveformSegment, packed_bit};
    ...
    fn check_waveform_against_samples(
        samples: &[bool],
        window: &crate::runtime::capture::CaptureSampledWindow,
        context: &str,
    ) {
